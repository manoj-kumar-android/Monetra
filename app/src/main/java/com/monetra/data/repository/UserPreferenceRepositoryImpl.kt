    ...
    override fun getUserPreferences(): Flow<UserPreferences> {
        return dao.getUserPreferences().map { entity ->
            UserPreferences(
                ...
                isBackupEnabled = entity?.isBackupEnabled ?: false,
                isSmartSuggestionEnabled = entity?.isSmartSuggestionEnabled ?: false,
                isBiometricEnabled = entity?.isBiometricEnabled ?: false,
                isPremiumUnlocked = entity?.isPremiumUnlocked ?: false,
    ...
    override suspend fun saveUserPreferences(preferences: UserPreferences) {
        ...
        dao.upsertUserPreferences(
            UserPreferencesEntity(
                ...
                isSmartSuggestionEnabled = preferences.isSmartSuggestionEnabled,
                isBiometricEnabled = preferences.isBiometricEnabled,
                isPremiumUnlocked = preferences.isPremiumUnlocked,
