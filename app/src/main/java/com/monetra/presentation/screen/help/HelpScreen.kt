        ...
        "INVESTMENTS" -> Pair(
            ...
            listOf(
                ...
                HelpSection(
                    ...
                    "Spend Sense works completely offline for your privacy. This means wealth values are calculated using mathematical projection formulas rather than real-time market feeds. All values shown are estimates based on your provided return rates."
                )
            )
        )
        "FIXED_COSTS" -> Pair(
